...
(function () {
    ...
    var PathFinding = function (args) {
    };

    PathFinding.prototype.getRoute = function (startPos, targetPos, funcIsBlocked) {
    ...
    PathFinding.prototype.startAstar = function (startPos, targetPos, funcIsBlocked) {
        var _start = {
            'x': startPos.x,
            'y': startPos.y,
            'next': null,
        ...
        _start.dist = getDistance(_start, targetPos);
        ...
        while (openList.hasNext()) {
            ...
            DIRECTION.forEach(function (dir) {
                ...
                nextPos.dist = getDistance(nextPos, targetPos);
